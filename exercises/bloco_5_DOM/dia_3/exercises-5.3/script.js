...
function setTasks() {
  let myTasks = document.getElementsByClassName('task selected')
...
Ao clicar novamente no dia com a cor da legenda, a sua cor deverá voltar à configuração inicial rgb(119,119,119). Gabarito
*/
