...
setTimeout(() => assert.deepStrictEqual(numbers, [2, 3, 1]), 3000); //precisou modificar a ordem
...
const getCountry = (onSuccess, onError) => {
  setTimeout(() => {
    ...
    if(didOperationSucceed) {
      ...
      onError(errorMessage); //acrescenta essa callback
    }
  }, delay());
};
